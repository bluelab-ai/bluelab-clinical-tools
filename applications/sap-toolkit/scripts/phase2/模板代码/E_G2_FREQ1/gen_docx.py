...
def generate_docx(filled_data, output_path):
    ...
    set_cell_text(table.rows[0].cells[7], "P值", WD_ALIGN_PARAGRAPH.LEFT)

    # 填写表头行2
    set_cell_text(table.rows[1].cells[0], "项目", WD_ALIGN_PARAGRAPH.LEFT)
    ...
    set_cell_text(table.rows[1].cells[7], "P值", WD_ALIGN_PARAGRAPH.LEFT)
