...
def fill_template(semantic, projects):
    ...
    for section in sections:
        section_label = section.get("category_label", "")
        ...
        if section_label == "提前中止退出":
            ...
            for row in section.get("rows", []):
                rows.append({
                    "label_values": ["", row["label_values"][1]],
...
def main():
    ...
    semantic_path = os.path.join(SCRIPT_DIR, "D_G1_EN.json")
