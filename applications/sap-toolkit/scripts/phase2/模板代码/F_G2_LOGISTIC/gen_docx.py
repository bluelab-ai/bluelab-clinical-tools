#!/usr/bin/env python3
"""
F_G2_LOGISTIC 生成脚本（Logistic回归分析表）
生成三线表 Word 文档
"""
    ...
    for ind_idx, indicator in enumerate(indicators):
        ...
        for i, row_data in enumerate(rows):
            ...
            if is_separator:
                ...
                # 第1列：指标名（只在第一行显示）
                set_cell_text(table.rows[row_idx].cells[0], indicator_text)
