#!/usr/bin/env python3
"""
F_G2_QUALSUB_Y_N 填充脚本（定性指标亚组-两组-有缺失）
...
def fill_template(semantic, projects, subgroups):
    ...
    # Y_N 的 rows 在 sections[0]["rows"] 中（非嵌套）
    ...
    for proj in projects:
        ...
        # 构建行模板：例数(缺失)、各分类、CI、统计方法、检验统计量、P值
        rows = []
...
def main():
    ...
    semantic_path = os.path.join(SCRIPT_DIR, "F_G2_QUALSUB_Y_N.json")
