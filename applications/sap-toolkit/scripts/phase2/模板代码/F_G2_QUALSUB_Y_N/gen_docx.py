...
示例:
    python gen_docx.py 填充结果.json
    python gen_docx.py 填充结果.json -o result.docx
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="基于填充好的 JSON 生成三线表 Word 文档（支持亚组-有缺失）"
    )
    ...
    if args.output:
        ...
        output_path = os.path.join(os.path.dirname(args.filled_json), f"{base}.docx")
