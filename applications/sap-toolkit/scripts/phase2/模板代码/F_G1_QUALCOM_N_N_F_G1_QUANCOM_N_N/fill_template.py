#!/usr/bin/env python3
"""
F_G1_QUALCOM_N_N_F_G1_QUANCOM_N_N 填充脚本
混合定性+定量指标的单组比较表

判断逻辑：
- 有 categories 字段 → 定性指标，按 F_G1_QUALCOM_N_N 方式填充
- 有 unit 字段且无 categories → 定量指标，按 F_G1_QUANCOM_N_N 方式填充
"""
...
def main():
    ...
    semantic_path = os.path.join(SCRIPT_DIR, "F_G1_QUALCOM_N_N_F_G1_QUANCOM_N_N.json")
