#!/usr/bin/env python3
"""
E_G3_FREQ3 生成脚本（不良事件发生情况表-多组-SOC/PT）
生成三线表 Word 文档
"""
...
def generate_docx(filled_data, output_path):
    ...
    # 合并表头行1：组别1 (列1-2), 组别2 (列3-4), 组别3 (列5-6), 合计 (列7-8)
    merge_cells(table, 0, 1, 2)  # 组别1
    merge_cells(table, 0, 3, 4)  # 组别2
    merge_cells(table, 0, 5, 6)  # 组别3
